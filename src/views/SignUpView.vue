    ...
    methods: {
        async submitForm() {
            ...
            if (this.form.username.length <= 3) {
                this.errors.push("Username 3 belgidan ko'proq bo'lishi kerak.");
            }
            if (this.form.password === '') {
                this.errors.push('Iltimos parolni kiriting.');
            }
            if (this.form.password.length < 8) {
                this.errors.push("Parol 8 belgidan ko'proq bo'lishi kerak");
            }
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form v-on:submit.prevent="submitForm" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div>
                            ...
                            <input v-model="form.password2" type="confirm-password"
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            ...
                            <RouterLink :to="{ name: 'login' }" href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">
                                Login
                             </RouterLink>
                        </p>
                    </form>
