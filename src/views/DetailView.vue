        ...
        async updateTodo() {
            ...
            try {
                ...
                if (error.response && error.response.status === 400) {
                    ...
                    console.error('validations Errors:', validationErrors);
                } else {
        ...
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                    ...
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        <div class="mr-4 rounded-full ">
                            ...
                            class="text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700">
                                <span class="text-xs inline-flex bg-primary-600 rounded-full text-white px-5 py-1.5">
                                <svg class="w-6 h-6 text-white dark:text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <p class="lead">
                <div class="sm:col-span-2">
                    <label for="descrip tion" class="block mb-2 text-sm font-medium text-gray-900">
